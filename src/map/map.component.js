System.register(['angular2/core', './map.service', 'rxjs/add/operator/distinctUntilChanged', 'rxjs/add/operator/repeat', 'rxjs/add/operator/debounceTime', 'rxjs/add/operator/delay', 'rxjs/add/operator/switchMap', 'rxjs/add/operator/mergeMap', 'rxjs/add/observable/interval', 'rxjs/add/operator/pluck'], function(exports_1) {
            ...
            MapComponent = (function () {
                ...
                MapComponent.prototype.updateRoute = function () {
                    ...
                    this.routeInfoStream
                        ...
                        _this._mapService.drawPath(data.coords);
                        _this._mapService.drawStops(data.stops);
                    });
                };
                MapComponent.prototype.initBuses = function () {
                    var _this = this;
                    if (this.busLocations)
                        this.busLocations.unsubscribe();
                    this.busLocations = this.locationStream
                        .subscribe(function (data) {
                        _this._mapService.drawBuses(data);
                ...
                MapComponent = __decorate([
                    core_1.Component({
                        ...
                        inputs: ['routeInfoStream', 'locationStream']
                    }), 
